...
exports.processTransactions = async() => {
    ...
    pendingTransactions.forEach(async transaction => {
       ...
       // add to accountTo
        const accountToBalance = await accountModel.findOne({ account_number: transaction.accountFrom })
        accountToBalance.balance = accountToBalance.balance + transaction.amount
        accountToBalance.save();
